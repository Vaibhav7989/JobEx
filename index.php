...
<body style="font-family: 'Lucida Sans';letter-spacing:2px;margin:auto;">
    ...
    <div id="navbar">
        <ul>
            <a href="index.php"><img src="imgs/logo.png" id="logoimg" /></a>
    ...
    <div id="main">
        ...
        <center>
            <div id="midtextbox">
                <h4>
                    JobEX gives you opportunity to Earn & Work Whenever You Want / Need.
                    <ul>
        ...
        <div id="sidebox">
            <ul>
                <h4 id="textbox">JobEX allows freelancers like you to work for anyone.</h4>
        ...
        <div id="aboutus">
            <ul>
                ...
                <h4 style="float:left">Soumik Kabiraj</h4><br><br>
                <h4 style="float:left">20BCE1504</h4>
            </ul>
            <ul>
                <img src="imgs/ava1.png" id="avatar" style="float:right" />
                <h4 style="float:right">Sankalp Bhatnagar</h4><br><br>
                <h4 style="float:right">20BCE1558</h4>
            </ul>
            <ul>
                <img src="imgs/ava1.png" id="avatar" style="float:left" />
                <h4 style="float:left">Sighakolli Vaibhav</h4><br><br>
                <h4 style="float:left">20BCE1530</h4>
            </ul>
	    <br><br>
            <center>
                <h2 style="font-weight: normal;">We are a 3 man team working to provide the best experience to our
                    customers!</h4>
            </center>
        </div>
        ...
        <div id="contactus">
            <center>
                ...
                <p>Follow us on Instagram @JobEX</p><i class="fab fa-instagram" style="font-size:36px"></i>
                <p>Reach us out on Linked in! @JobEX</p><i class="fab fa-linkedin" style="font-size:36px"></i>
